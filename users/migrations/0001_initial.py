    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('donor', 'Donor'), ('doctor', 'Doctor'), ('bloodbank', 'Blood Bank')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='donor_profile', to='users.user')),
            ],
        ),
        migrations.CreateModel(
            name='DoctorProfile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='bank_profile', to='users.user')),
            ],
        ),
    ]
